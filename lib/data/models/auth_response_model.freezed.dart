...
abstract class $AuthResponseModelCopyWith<$Res> {
  ...
  @useResult
  $Res call({String token, String refreshToken, UserData user});
...
class _$AuthResponseModelImpl implements _AuthResponseModel {
  ...
  @override
  String toString() {
    return 'AuthResponseModel(token: $token, refreshToken: $refreshToken, user: $user)';
  }
...
abstract class _AuthResponseModel implements AuthResponseModel {
  const factory _AuthResponseModel(
      ...
      required final UserData user}) = _$AuthResponseModelImpl;
...
class _$UserDataImpl implements _UserData {
  ...
  @override
  String toString() {
    return 'UserData(id: $id, username: $username, email: $email, role: $role, status: $status, avatarUrl: $avatarUrl)';
  }
  ...
  @override
  int get hashCode =>
      Object.hash(runtimeType, id, username, email, role, status, avatarUrl);
...
abstract class _UserData implements UserData {
  const factory _UserData(
      ...
      final String? avatarUrl}) = _$UserDataImpl;
